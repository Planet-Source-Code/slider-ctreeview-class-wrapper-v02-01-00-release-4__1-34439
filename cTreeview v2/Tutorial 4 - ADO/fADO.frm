...
Begin VB.Form fADO 
   ...
   Caption         =   "Tutorial 4: ADO CODE EXAMPLE"
   ClientHeight    =   6930
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9360
   ...
   Begin MSComctlLib.ImageList imgDialog 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":27A2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":2D3C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":32D6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":3870
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":3E0A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":43A4
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":46BE
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":49D8
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":4E2A
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fADO.frx":5144
            Key             =   ""
         EndProperty
      EndProperty
   End
...
'===========================================================================
'
' Form Name:    fADO [Tutorial 4]
' Author:       Graeme Grant        (a.k.a. Slider)
' Date:         01/05/2002
' Version:      02.00.01            (Version is inline with cTREEVIEW class)
...
'               02.00.00 23/03/2002 Modified to work with v2 of cTREEVIEW
'                                   class.
'               02.00.00 23/03/2002 Added Overlay Icons to identify which
'                                   group nodes are loaded/emppty.
'               02.00.01 01/05/2002 Fix bug with drag'n'drop operation -
'                                   now shows 'override icon' during drag
'                                   operation instead of default (drag node
'                                   icon)
'
...
Private Sub cmdTest_Click()
    ...
    sResults() = GetChildParentKeys(tvwDialog.SelectedItem)
    For iLoop = LBound(sResults) To UBound(sResults)
        Debug.Print "Node = "; _
                    tvwDialog.Nodes(sResults(iLoop)).Text, _
                    "Key = "; _
                    sResults(iLoop), _
                    "FullPath= "; _
                    tvwDialog.Nodes(sResults(iLoop)).FullPath
    Next

End Sub

Private Function GetChildParentKeys(oNode As MSComctlLib.Node) As String()
    ...
    ReDim Preserve skeys(1 To 1)
    Do
        lMax = lMax + 1
        ReDim Preserve skeys(1 To lMax)
        skeys(lMax) = otNode.Key
        Debug.Print otNode.Text, otNode.Key
        If Not (otNode.FullPath = otNode.Text) Then
            Set otNode = otNode.Parent
        Else
            '## Root node reached
            GetChildParentKeys = skeys()
            Exit Do
        End If
    Loop
...
#End If
    ...
    With moTree
        ...
        '
        .SetOverlayImage imgDialog.hImageList, 8, [Custom 1]
        .SetOverlayImage imgDialog.hImageList, 9, [Custom 2]
        '
...
Private Sub mnuNode_Click(Index As Integer)                     '@@ v01.00.01
    ...
    Select Case Index
        Case [Menu Add]
            moTree.CutIcon = False                              '@@ v01.00.03 !v02.00.00
            Set moSelectedNode = tvwDialog.SelectedItem         '## Remember selected node
        ...
        Case [Menu Cut]                                         '@@ v01.00.03
            moTree.CutIcon = True                               '@@ v01.00.03 !v02.00.00
            Set moSelectedNode = tvwDialog.SelectedItem         '@@ Remember selected node
            mbCutOperation = True                               '@@
            cmdDialog_Click [Move Node]                         '@@ Press Move button
            txtDialog([Node Text]).Text = moSelectedNode.Text   '@@ Update screen with selected item
...
'
Private Sub moTree_CopyNode(DestNode As MSComctlLib.INode, _
                            SrcNode As MSComctlLib.INode, _
                            Cancel As Boolean) '@@ v02.00.00

'Private Sub moTree_CopyNode(DestNode As MSComctlLib.Node, _
'                            SrcNode As MSComctlLib.Node)  '@@ v01.00.03
    '
...
Private Sub moTree_Dragging(SourceNode As MSComctlLib.Node, TargetParent As MSComctlLib.Node)
    ...
    '## Node being dragged
    '
    If Left$(SourceNode.Key, 1) = "N" Then                      '@@ v01.00.01 \ v02.00.01 moved (see '%% below)
    ...
    If msDragTarget <> TargetParent.Text Then   '## Only proceed if a different node
        '%% v02.00.01 moved code above - effect not visible here! (Bug fix)
...
Private Sub pLoadGroups(Optional GroupID As Long = 0)
    ...
    If mcDB.CreateRS(oRs, mcSQL_GRP1 + CStr(GroupID) + mcSQL_GRP2) Then
        ...
        '## Yes.
        '
        If GroupID Then                                                             '@@ v02.00.00
            moTree.OverlayIcon(tvwDialog.Nodes("N" + CStr(GroupID))) = [Custom 2]   '@@
        End If                                                                      '@@
            ...
            With oRs
                ...
                For lLoop = 1 To lCount
                    ...
                    If !GroupID Then
                        ...
                        moTree.OverlayIcon(tvwDialog.Nodes(sKey)) = [Custom 1]
                        '
    ...
    If moTree.NodeRename(Node, NewText, True) Then
        Select Case Left$(Node.Key, 1)
            ...
            Case "P"
                ...
                '
                SSQL = mcSQL_RPRD1 + NewText + mcSQL_RPRD2 + Mid$(Node.Key, 2) + mcSQL_RPRD3    '@@ v02.00.00
        End Select
        '
        '## Update Record
        '
