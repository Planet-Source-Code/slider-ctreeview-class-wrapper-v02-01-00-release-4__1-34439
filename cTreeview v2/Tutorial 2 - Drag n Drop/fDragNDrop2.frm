   ...
   Begin MSComctlLib.ImageList ilDialog 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            ...
            Key             =   ""
            Object.Tag             =   "Closed Group"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fDragNDrop2.frx":2D3C
            Key             =   ""
            Object.Tag             =   "Open Group"
         EndProperty
         ...
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            ...
            Key             =   ""
            Object.Tag             =   "Closed Book"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fDragNDrop2.frx":43A4
            Key             =   ""
            Object.Tag             =   "Open Book"
         EndProperty
...
Private Sub pInitData()
    ...
    '
    '## Fill treeview with sample data
    '
    With moTree
        For lLoop1 = 65 To 70
            sChar1 = Chr$(lLoop1)
            .NodeAdd , , sChar1, "Folder " + sChar1, 1, 1, , , , , , , , , , 2
            For lLoop2 = 1 To 5
                sChar2 = sChar1 + CStr(lLoop2)
                .NodeAdd tvwDialog.Nodes(sChar1), tvwChild, sChar2, "Sub Folder " + sChar2, 3, 3, , , , , , , , , , 4
                For lLoop3 = 1 To 3
                    sChar3 = sChar2 + CStr(lLoop3)
                    sText = "Book ID " + CStr(lLoop3)
                    .NodeAdd tvwDialog.Nodes(sChar2), tvwChild, sChar3, sText, 5, 5, , , , , , , , , , 6
                    For lLoop4 = 1 To 3
                        .NodeAdd tvwDialog.Nodes(sChar3), tvwChild, sChar3 + "-" + CStr(lLoop4), "Chapter " + CStr(lLoop4) + "[" + sText + "]", 7, 7, , , , , , , , , , 7
                    Next
                Next
            Next
        Next
